          ...
          <div class="col-md-3">
            ...
            >
              ...
              <button
                ...
                id="v-pills-cibc-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-pills-cibc"
                type="button"
                role="tab"
                aria-controls="v-pills-cibc"
                aria-selected="false"
              >
                CIBC
              </button>
          ...
          <div class="col-md-9">
            <div class="tab-content" id="v-pills-tabContent">
              ...
              >
                ...
                <div className="role-description">
                  <ul>
                    ...
                    <li>
                      Collaborating with a team to create a seamless and
                      efficient user experience for the Fibra app through the
              ...
              <div
                ...
                id="v-pills-cibc"
                role="tabpanel"
                aria-labelledby="v-pills-cibc-tab"
                tabindex="0"
              >
                <div className="role-title">
                  <p>
              ...
              >
                ...
                <div className="role-description">
                  ...
                  <ul>
                    <li>
                      Setting up a database and integrating with payment
                      gateways to streamline the checkout process
                    </li>
                    <li>
